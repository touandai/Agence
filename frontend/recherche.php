...
<?php
    if($result){
       echo "<h6 class='text-center'><b><a class='lien' href='circuits.php'> Détails circuits >> </a></h6><br>";
    }else {
    echo "<p class='text-center'><b> Désolé, aucun résultat ne correspond à votre recherche ! </b><br>
    <h6 class='text-center'><b><a class='lien' href='circuits.php'> Acceder à tous les circuits >> </a></h6>
    </p>";
    }
    ?>
