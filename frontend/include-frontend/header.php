...
<div class="container entete">
        ...
        <div id="logo">
            ...
            <img src="icons/airplane-fill.svg" alt="avion"/>
        </div>
</div>
<header>
        <nav class="navbar navbar-expand-md bg-light" data-bs-theme="white">
            ...
            <div id="navbarNav" class="collapse sous-titre navbar-collapse">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="sejours-destinations.php">Séjours/Destinations</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="galerie.php">Galérie photos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="circuits.php">Circuits et Bons plans</a>
                    </li>
                    <li class="nav-item">
