...
<?php 
$Title='Destinations, Afrique Centrale Découverte';
    ...
    <section class="container text-center p-4">
        ...
        <div class="row row-cols-2">     
            ...
            <div class="col border rounded">
                ...
                du pétrole et gaz. Il est cependant doté d'un <b>tres beau paysage à visiter</b>
               </p> 
            </div>
             ...
             <div class="row row-cols-2">     
                ...
                <div class="col border rounded">
                   ...
                   <P class="rounded">Votre séjour touristique au Gabon vous conduira dans l'un des 
                    ...
                    <b>Aimez-vous la pêche?</b> Prevoyez alors ce qu'il faut car des poissons, 
                    il y'en a plein !  
                   </p> 
                </div>
