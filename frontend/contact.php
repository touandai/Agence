                 ...
                 <legend>Pour toutes vos question, vous pouvez nous envoyer votre message</legend>   
                   ...
                   <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" maxlength="30" name="nom" id="nom" placeholder="Dupont">
                        <?php
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="email" maxlength="30" name="email" id="email" placeholder="monadresse@.....">
                        <?php
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="text" maxlength="15" name="telephone" id="telephone" placeholder="+236....">
                    </div>
